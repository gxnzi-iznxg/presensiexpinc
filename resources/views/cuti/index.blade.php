    ...
    <div class="page-header d-print-none" aria-label="Page header">
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    <h2 class="page-title">Data Cuti</h2>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <form action="/cuti/{{ $d->kode_cuti }}/delete" method="POST" style="margin-left: 10px">
                                                                @csrf
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                                ...
                                <input type="text" id="nama_cuti" value="" class="form-control" placeholder="Nama Cuti" name="nama_cuti">
                              </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                                ...
                                <input type="text" id="jml_hari" value="" class="form-control" placeholder="Jumlah Hari" name="jml_hari">
                              </div>
                    </div>
                </div>
...
<script>
  $(document).ready(function() {
    ...
    $("#btnTambahCuti").click(function(e) {
      e.preventDefault();
    ...
    var kode_cuti = $("#kode_cuti").val().trim();
    var nama_cuti = $("#nama_cuti").val().trim();
    var jml_hari = $("#jml_hari").val().trim();
