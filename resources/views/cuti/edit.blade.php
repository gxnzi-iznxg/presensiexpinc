                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                                ...
                                <input type="text" id="nama_cuti" value="{{ $cuti->nama_cuti }}" class="form-control" placeholder="Nama Cuti" name="nama_cuti">
                              </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                                ...
                                <input type="text" id="jml_hari" value="{{ $cuti->jml_hari }}" class="form-control" placeholder="Jumlah Hari" name="jml_hari">
                              </div>
                    </div>
                </div>
