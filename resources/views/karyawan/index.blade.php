                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @foreach ($karyawan as $d)
                                                @php
                                                    $path = Storage::url('/public/uploads/karyawan/' . $d->foto);
                                                @endphp
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if (empty($d->foto))
                                                            <img src="{{ asset('assets/img/nophoto.jpg') }}" class="avatar" alt="nophoto">
                                                        @else
                                                            <img src="{{ url($path) }}" class="avatar" alt="{{ $d->nama_lengkap }}">
                                                        @endif
                                                    </td>
                                                    <td>{{ $d->nama_dept }}</td>
                                                    <td>
                    ...
                    <div class="col-12">
                        <div class="input-icon mb-3">
                                <span class="input-icon-addon">
                                  ...
                                  fill="none"/><path d="M4 7v-1a2 2 0 0 1 2 -2h2" /><path d="M4 17v1a2 2 0 0 0 2 2h2" /><path d="M16 4h2a2 2 0 0 1 2 2v1" /><path d="M16 20h2a2 2 0 0 0 2 -2v-1" /><path d="M5 11h1v2h-1z" />
                                  <path d="M10 11l0 2" /><path d="M14 11h1v2h-1z" /><path d="M19 11l0 2" /></svg>
                                </span>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                                <span class="input-icon-addon">
                                  <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                                  <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-building-skyscraper"><path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    <path d="M3 21l18 0" />
                    ...
                    <div class="col-12">
                        <div class="input-icon mb-3">
                                <span class="input-icon-addon">
                                  ...
                                  <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  
                                  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  
                                  class="icon icon-tabler icons-tabler-outline icon-tabler-phone"><path 
                                ...
                                <input type="text" maxlength="13" id="no_hp" value="" class="form-control" name="no_hp" placeholder="No. HP">
                              </div>
                    </div>
                </div>
                <div class="row mt-2">
...
<script>
  $(document).ready(function() {
    ...
    // Gunakan selector spesifik untuk form modal
    var kode_dept = $("#frmKaryawan select[name='kode_dept']").val();
    ...
    if (nik == "") {
        ...
        return false;
    } else if (kode_dept == "" || kode_dept == null) {
        e.preventDefault();
        Swal.fire({
            title: 'Warning!',
            ...
            // Focus ke select departemen dalam form
            $("#frmKaryawan select[name='kode_dept']").focus();
        });
        return false;
    }
