...
<div class="row">
    <div class="col">
            ...
            <div class="row">
                <div class="col-12">
                    <button class="btn btn-warning w-100" id="getdata">Cari Data</button>
                </div>
            </div>
    </div>
</div>
<div class="row mt-2" style="position: fixed; width:100%; margin:auto; overflow-y:auto; height:550px">
