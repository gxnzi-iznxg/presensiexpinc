...
<div class="row">
    <div class="col">
        <form method="GET" action="/presensi/izin">
                    ...
                    <div class="form-group">
                        <select name="tahun" id="tahun" class="form-control selectmaterialize">
                            <option value="">Tahun</option>
                                ...
                                @endphp
                                @foreach (range($tahun_awal, $tahun_sekarang) as $t)
                                    <option {{ Request('tahun') == $t ? 'selected' : '' }} value="{{ $t }}">{{ $t }}</option>
                                @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <button class="btn btn-warning w-100">Cari Data</button>
                </div>
            </div>
        </form>
    </div>
...
<div class="row" style="position: fixed; width:100%; margin:auto; overflow-y:auto; height:550px">
    <div class="col">
                    ...
                    <div class="historicontent">
                        ...
                        <div class="datapresensi">
                            ...
                            <p>
                                ...
                                <br>
                                @if ($d->status=="C")
                                    <span class="badge bg-dark">{{ $d->nama_cuti }}</span>
                                @endif
                                @if (!empty($d->doc_sid))
                        ...
                        <div class="status">
                            ...
                            @endif
                            <p style="margin-top:5px; text-align:right; font-weight:bold"> {{ hitunghari($d->tgl_izin_dari, $d->tgl_izin_sampai) }}  Hari</p>
                        </div>
                    </div>
                </div>
            </div>
