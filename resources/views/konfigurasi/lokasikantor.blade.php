<!-- 12 copy laporan ke lokasikantor pada menit 29:55 -->
        ...
        <div class="container-xl">
            <div class="row">
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            <!-- menit 40:05 copy session dari /karyawan/index.blade.php -->
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <!-- 13. copy form inputnya di karyawan/index.blade.php yang ada input-icon-addon yang dimuladi dari div class row -->
                                            <div class="row">
                                                <div class="col-12">
