...
class IzinabsenController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($cekpresensi->count() > 0) {
            ...
            return redirect('/presensi/izin')->with(['error' => 'Tidak Dapat Melakukan Pengajuan Izin, Anda Sudah Melakukan Presensi Pada Tanggal ' . $blacklistdate . ' Silahkan Ganti Tanggalnya !']);
        } else if ($cekpengajuan->count() > 0) {
            return redirect('/presensi/izin')->with(['error' => 'Tidak Dapat Melakukan Pengajuan Izin, Anda Sudah Melakukan Pengajuan Sebelumnya Pada Tanggal ' . $blacklistdate . ' Silahkan Ganti Tanggalnya !']);
        } else {
